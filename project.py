...
def open_dashboard():
    ...
    label3=tk.Label(dashboard, text="Model Name")
    label3.grid(row=0, column=0, padx=10, pady=10)
    model_entry = tk.Entry(dashboard)
    model_entry.grid(row=0, column=1, padx=10, pady=10)

    label4=tk.Label(dashboard, text="Brand")
    label4.grid(row=1, column=0, padx=10, pady=10)
    brand_entry = tk.Entry(dashboard)
    brand_entry.grid(row=1, column=1, padx=10, pady=10)

    label5=tk.Label(dashboard, text="Price per Day")
    ...
    # Add Car Button
    button=tk.Button(dashboard, text="Add Car", command=add_car)
